                ...
                <tr>
                    ...
                    <td class="px-4 py-2 border-2">
                        @if(isset($regis['payment']['number_payment']))
                            <a class="hover:border-gray-900 border-dotted border-b-2 border-gray-400 text-gray-700" href='{{ url("/files/pembayaran/{$regis["file"][0]["name_file"]}") }}' target="_blank">{{ $regis['payment']['number_payment'] }} ( {{ $regis['payment']['bank_payment'] }} )</a>
                        @else
                        -
                        @endif
                    </td>
