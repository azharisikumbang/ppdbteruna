  ...
  <div class="w-full max-w-sm mx-auto mt-20">
    ...
    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" method="POST" action="{{ url('/admin/add') }}">
      ...
      <div class="mb-4">
        ...
        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="username" type="text" placeholder="Username" value="{{ $username ?? '' }}" autofocus="autofocus">
      </div>
      <div class="mb-6">
